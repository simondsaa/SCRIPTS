...
$filepath = ("C:\Temp\SDC_NOT_Pinging1.txt")
...
$TC = Test-Connection $Computer -quiet -count 1   
        ...
        If($TC -eq $False)
          ...
          $Ping | Out-File "C:\Temp\SDC_Pinging1.txt"
 }
...
$54 = '5.4'
$53 = '5.3'
$PCs = gc "C:\Temp\SDC_Pinging1.txt"
ForEach($Computer in $PCs){                                
                ($LC = Get-ADComputer $Computer -Property Location).Location
                If($LC -eq "B*")
                    {
                        $obj = New-Object PSObject
                        $obj | Add-Member -Force -MemberType NoteProperty -Name "ComputerName" -Value $Computer
                        $obj | Add-Member -Force -MemberType NoteProperty -Name "Location" -Value $LC
                        write-host "NOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO" -ForegroundColor Yellow
                    }              
...
$Array | Select ComputerName, OSVersion, Location | OGV -Title "Computer SDCs"
Write-Host "===================================================="
Write-Host "=================" -NoNewline -ForegroundColor Black
