...
$Comp = Read-Host "User Name"
    ...
    ElseIf ($Comp -eq "Cain"){$Compname = "XLWUW-491S64"}
    ...
    ElseIf ($Comp -eq "Foster"){$Compname = "XLWUW-47168P"}
    ...
    ElseIf ($Comp -eq "Worley"){$Compname = "XLWUW-6491S3B"}
...
Function CDROM2
{
$Computer = Get-Content C:\Temp\Pop.txt
...
#add computers to computers variable to search for profiles on those computers 
    [array] $Computers = Get-Content "C:\temp\testing.txt"
...
{
$Computer = Get-Content C:\Temp\Computers_1.txt
...
Do
{
    ...
    Write-Host -ForegroundColor Gray "3 - Lock Computer"
    Write-Host -ForegroundColor Gray "4 - Logoff User"
    Write-Host -ForegroundColor Gray "5 - Reboot Computer"
    Write-Host "6 - Enable Local Admin"
    Write-Host -ForegroundColor Green "7 - Clear BIOS Password"
    Write-Host -ForegroundColor Green "8 - Set BIOS Password"
    Write-Host "9 - Enable/Disable BIOS Component"
    Write-Host "10 - Enter-PSSession"
    Write-Host -ForegroundColor Yellow "11 - PCs per BLDG & RM"
    Write-Host -ForegroundColor Yellow "12 - PC & User - C:\Temp\test.txt"
    Write-Host "13 - CD-Rom - Multi:  C:\Temp\Pop.txt"
    Write-Host -ForegroundColor Gray "14 - Copy File (Single PC)"
    Write-Host -ForegroundColor Gray "15 - Copy File (Multi PCs) - edit script 1st"
    Write-Host -ForegroundColor Gray "16 - Delete File (Multi PCs) - edit script 1st"
    Write-Host "17 - Delete Profiles - C:\temp\testing.txt"
    Write-Host -ForegroundColor Green "18 - Ping & NsLookup"
    Write-Host -ForegroundColor Green "19 - Ping Tool - C:\Temp\Computers.txt"
    Write-Host "20 - C$"
    Write-Host "21 - GPUpdate"
    Write-Host -ForegroundColor Yellow "22 - Stop-Process"
    Write-Host -ForegroundColor Yellow "23 - Stop-Explorer"
    Write-Host "24 - PSRecon - Must run PS as Admin"
    Write-Host "25 - Exit"
    Write-Host " "
    ...
    {
    Write-Host " "
    Write-Host "1 - Enter Computer Name"
    Write-Host "2 - (NOT WORKING) Enter Path:  C:\Temp\Computers_1.txt"
    Write-Host "3 - Alex"
    Write-Host "4 - Arnold"	
    Write-Host "5 - Ballentine"	
    Write-Host "6 - Barnett"	
    Write-Host "7 - Ben"	
    Write-Host "8 - Brown"	
    Write-Host "9 - Cain"	
    Write-Host "10 - Dossa"	
    Write-Host "11 - Ed"	
    Write-Host "12 - Gail"	
    Write-Host "13 - Ginger" 	
    Write-Host "14 - Goldman" 	
	Write-Host "15 - Grainger"
	Write-Host "16 - Cunningham"
	Write-Host "17 - Hiserodt"
	Write-Host "18 - Johns"
	Write-Host "19 - Lafond"
	Write-Host "20 - Linde"
	Write-Host "21 - Lozada"
	Write-Host "22 - Mac"
	Write-Host "23 - Mowry"
	Write-Host "24 - Oster"
	Write-Host "25 - Pelletier"
	Write-Host "26 - Pelletier Admin"
	Write-Host "27 - Scheffrin"
	Write-Host "28 - SMSgt Larry"
	Write-Host "29 - Thrift"
	Write-Host "30 - Walden"
	Write-Host "31 - Worley"
        $Pick = Read-Host "Choose a Victim/Customer"  
            If ($Pick -eq 1)	
                {	
                  Write-Host          
