...
$handler_button1_Click= 
{
    ...
    If ($checkBox1.Checked){ Test-Connection xlwuw3-dkpvv1 | Format-Table | Out-String -OutVariable Results
    $BoxList1 = $Results
    $listBox1.Items.Add( "$BoxList1" ) }

    If ($checkBox2.Checked)    {  $listBox1.Items.Add( "$ScriptBlock2"  ) }

    If ($checkBox3.Checked)    {  $listBox1.Items.Add( "$ScriptBlock3"  ) }
