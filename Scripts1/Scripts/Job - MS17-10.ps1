...
# Target List
$Comps = Get-Content C:\Users\1180219788A\Desktop\test.txt
...
$scriptblock = {
 ...
 $ping = "Online"
    ...
    Try {
    $create1 = schtasks.exe /CREATE /TN "MS17-10" /S $args /SC ONCE /ST 23:00 /RL HIGHEST /RU SYSTEM /TR "powershell.exe -noprofile -File 'C:\Users\1180219788A\Downloads\17-10\17-10.ps1'" /F
    $run1 = schtasks.exe /RUN /TN "MS17-10" /S "$args"
    Sleep -Milliseconds 10
    $delete1  = schtasks.exe /DELETE /TN "Job" /s  "$args" /F
    $success = "True"
...
$MaxThreads = 30 # Max number of concurrent threads
