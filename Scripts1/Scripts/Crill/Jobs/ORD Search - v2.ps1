...
$DirTOP = Get-Childitem "\\xlwu-fs-05pv\Tyndall_ord" -Directory |Sort-object | Select Fullname
} 
ELSE { # Universal PSVersion scan
$DirTOP = Get-Childitem "\\xlwu-fs-05pv\Tyndall_ord" | where {$_.PsIsContainer} | Sort-object | Select-Object FullName
}
