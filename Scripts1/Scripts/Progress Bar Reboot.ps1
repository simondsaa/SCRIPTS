$Wait = (New-TimeSpan -End 15:47).TotalSeconds
...
$Message = "A system reboot is required on this system, please save all work. Your system will reboot in $RebootM minutes."
