...
$Computers = Get-Content "C:\Users\1392134782A\Desktop\JavaPatch.txt"

$Path = "C:\Users\1392134782A\Documents\JavaPush.csv"
...
$ScriptBlock = {
    If (Test-Connection $args[0] -Quiet -Count 1 -BufferSize 16 -Ea 0)
    {
        ...
        Try
        {
            $Task = schtasks.exe /CREATE /TN "Java" /S $args[0] /SC ONLOGON /RU "INTERACTIVE" /TR "powershell.exe -WindowStyle Hidden -noprofile -File '\\xlwu-fs-05pv\Tyndall_PUBLIC\NCC Admin\Java_Install.ps1'" /F  
