...
# You will need to omit the $Task or $Delete depending on what you want to do.
...
$Path = "C:\Users\1392134782A\Documents\Reboot Task Schedule.csv"
...
$ScriptBlock = {
    ...
    {    
        If (Test-Connection $args[0] -Quiet -Count 1 -BufferSize 16 -Ea 0)
        {
            ...
            #$Task = schtasks.exe /CREATE /TN "Reboot" /S $args[0] /SC ONCE /ST 18:00 /RL HIGHEST /RU INTERACTIVE /TR "powershell.exe -ExecutionPolicy Unrestricted -WindowStyle Hidden -noprofile -File '\\xlwu-fs-05pv\Tyndall_PUBLIC\NCC Admin\Progress Bar Reboot.ps1'" /F
            $Success = "True"
