...
If (Test-Connection $Computer -Quiet -BufferSize 16 -Ea 0 -Count 1)
{
    ...
    $ProgInfo = Get-WmiObject Win32_Product -ComputerName $Computer -ErrorAction SilentlyContinue | Select Name, Version, InstallDate, Vendor, HelpLink | Sort-Object "Name"
...
<tr>
<td class='first'>Pre-Windows 2000:</td>
<td>$Pre</td>
</tr>
<tr class='alt'>
