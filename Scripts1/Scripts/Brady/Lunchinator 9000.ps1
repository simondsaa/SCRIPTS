...
{
    $Exclusions = 
    $Places = $checkBox1, $checkBox2, $checkBox3, $checkBox4, $checkBox5, $checkBox6, $checkBox7, $checkBox8, $checkBox9, $checkBox10, $checkBox11, $checkBox12, $checkBox12, $checkBox14, $checkBox15, $checkBox16
    ...
    Send-MailMessage -From "timothy.brady.11@us.af.mil" -To "timothy.brady.11@us.af.mil", "lonnie.stringer.3@us.af.mil", "leej.tobler@us.af.mil", "ashley.thompson.21@us.af.mil", "john.fisher.26@us.af.mil", "bryan.mccausland@us.af.mil" -Priority High -Subject "Lunch" -Body $Body -SmtpServer wrightpatterson.oa.us.af.mil
}
