...
$appVendor = "Oracle"
$appName = "Java Version 8 Update 77"
$appVersion = [Version]"8.0.770.3"
$appArch = ""
$appLang = "EN"
$appRevision = "01"
...
#        Execute-Process -FilePath "setupX64.exe" -Arguments "/s" -WindowStyle Hidden -ContinueOnError $true
	Execute-MSI -Action Install -Path "jre1.8.0_77_x64.msi" -Parameters "AUTOUPDATECHECK=0 JAVAUPDATE=0 RebootYesNo=No REBOOT=ReallySuppress /QN" -ContinueOnError $true

        Write-Log "Installing 32 bit version of java"

#        Execute-Process -FilePath "setupX86.exe" -Arguments "/s" -WindowStyle Hidden
	Execute-MSI -Action Install -Path "jre1.8.0_77_x86.msi" -Parameters "AUTOUPDATECHECK=0 JAVAUPDATE=0 RebootYesNo=No REBOOT=ReallySuppress /QN" -ContinueOnError $true
