...
$Path = "\\XLWUW-DJPVV1\C$\Users\1274873341C\Desktop\Desktop\PS_Scripts\_PSAppDeployToolkit_v3.6.8\Flash_Update\Toolkit\Flash_Results.csv"
...
$ScriptBlock = {
    ...
    {    
        If (Test-Connection $args[0] -Quiet -Count 1 -BufferSize 16 -Ea 0)
        {
            ...
            $Task = schtasks.exe /CREATE /TN "Flash_Update" /S $args[0] /SC ONLOGON /RU "SYSTEM" /TR "powershell.exe -ExecutionPolicy Unrestricted -noprofile -File '\\XLWUW-DJPVV1\C$\Users\1274873341C\Desktop\Desktop\PS_Scripts\_PSAppDeployToolkit_v3.6.8\Flash_Update\Toolkit\Deploy-Application.ps1'" /F
            Sleep -s 1
