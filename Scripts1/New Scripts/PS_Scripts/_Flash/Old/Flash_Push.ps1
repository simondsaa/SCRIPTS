...
$Computers = Get-Content "\\52xlwu-ps-001p\Users\1274873341.adm\Desktop\Program Scripts\Flash\hosts.txt"

$Path = "\\52xlwu-ps-001p\Users\1274873341.adm\Desktop\Program Scripts\Flash\Logs_Flash.csv"
...
$ScriptBlock = {
    If (Test-Connection $args[0] -Quiet -Count 1 -BufferSize 16 -Ea 0)
    {
        ...
        Try
        {
            $Task = schtasks.exe /CREATE /TN "Flash" /S $args[0] /SC ONLOGON /RU "INTERACTIVE" /TR "powershell.exe -noprofile -File 'C:\Users\1274873341C\Desktop\Desktop\PS_Scripts\_Flash\Flash_Install.ps1'" /F  
